...
interface QuestionAnswerWebService {
    ...
    suspend fun updateQuestionAnswer(@Path("id") id: Int, @Body questionAnswer: QuestionAnswerResponseDTO): QuestionAnswerResponse
    ...
    suspend fun getCorrectQuestionAnswerOrNot(@Path("questionId") questionId: Int
                                              , @Path("questionAnswerId") questionAnswerId: Int): QuestionAnswerResponse
    ...
    suspend fun getQuestionAnswerByQuestionIdByStudentId(@Path("studentId") studentId: Int
                                                         ,@Path("questionId") questionId: Int): QuestionAnswerResponse
}