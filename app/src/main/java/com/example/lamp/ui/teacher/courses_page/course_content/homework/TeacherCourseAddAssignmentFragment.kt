...
class TeacherCourseAddAssignmentFragment:Fragment() {
    ...
    private fun initViews() {
        viewBinding.startDateTxt.setText(""+calendar.get(Calendar.DAY_OF_MONTH)+"/"+ calendar.get(Calendar.MONTH)+"/"
                + calendar.get(Calendar.YEAR))
        viewBinding.startDateTxt.setOnClickListener{
            showDatePicker(viewBinding.startDateTxt)
        }
        viewBinding.endDateTxt.setText(""+calendar.get(Calendar.DAY_OF_MONTH)+"/"+ calendar.get(Calendar.MONTH)+"/"
                + calendar.get(Calendar.YEAR))
