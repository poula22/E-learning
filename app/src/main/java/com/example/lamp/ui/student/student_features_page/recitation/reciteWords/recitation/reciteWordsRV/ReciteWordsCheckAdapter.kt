...
class ReciteWordsCheckAdapter(var wordsList:List<ReciteWordsItem>?,var selector:Int):RecyclerView.Adapter<ReciteWordsCheckAdapter.ViewHolder>() {
        class ViewHolder(var viewDataBinding: ItemReciteWordCheckBinding): RecyclerView.ViewHolder(viewDataBinding.root){
