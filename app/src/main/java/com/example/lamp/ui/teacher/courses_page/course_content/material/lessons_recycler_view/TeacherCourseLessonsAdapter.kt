...
class TeacherCourseLessonsAdapter(var lessonList:MutableList<LessonItem?>):RecyclerView.Adapter<TeacherCourseLessonsAdapter.ViewHolder>(){
...
//                arrow.setImageResource(android.R.drawable.arrow_up_float);
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val sectionAdapter = TeacherCourseLessonsSectionsAdapter(
            item?.lessonSection
        )
